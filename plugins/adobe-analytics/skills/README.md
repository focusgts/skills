...
This folder contains the Adobe Analytics agent skills shipped with this plugin. Each skill packages instructions, references, and helper assets for a focused Adobe Analytics workflow. This README is for human maintainers; agents should start from each skill's `SKILL.md`.

## Skills inventory

| Name | Purpose | Status |
| --- | --- | --- |
| aa-kpi-pulse | KPI digest with period-over-period change and top mover callout. | Active |
| aa-top-movers-watchlist | Ranks dimension items by biggest gain or loss for a metric. | Active |
| aa-conversion-funnel-analysis | Step-by-step fallout analysis across a multi-step conversion funnel. | Active |
| aa-segment-performance-comparator | Side-by-side KPI comparison across two or more audience segments. | Active |
| aa-executive-briefing | Narrative performance summary ready for leadership or QBR. | Active |
